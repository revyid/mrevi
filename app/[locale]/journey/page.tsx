    ...
    <div className="space-y-24 w-full">
      ...
      <section className="divide-y divide-border">
        {experiences.map((e: Record<string, unknown>) => (
          <div key={e.id as string} className="group flex flex-col sm:flex-row sm:items-center gap-4 py-6 first:pt-0 last:pb-0 transition-all hover:bg-white/[0.02] rounded-lg">
