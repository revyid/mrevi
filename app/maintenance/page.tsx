      ...
      <head>
        ...
        <style>{`
          *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .dot { width: 6px; height: 6px; border-radius: 50%; background: #eab308; display: inline-block; animation: pulse 2s infinite; }
          ...
          .dmx span { width: 6px; height: 6px; border-radius: 50%; background: #fafafa; animation: dmx-pulse 1.1s ease-in-out infinite; }
