      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-2">
            ...
            <Input value={settings.stat_1_num || ""} onChange={(e) => update("stat_1_num", e.target.value)} placeholder="Number (e.g. 10+)" />
            <Input value={settings.stat_1_label || ""} onChange={(e) => update("stat_1_label", e.target.value)} placeholder="Label (multi-line)" />
          </div>
          <div className="space-y-2">
            <p className="text-sm font-medium">Stat 2</p>
            <Input value={settings.stat_2_num || ""} onChange={(e) => update("stat_2_num", e.target.value)} placeholder="Number (e.g. 10+)" />
            <Input value={settings.stat_2_label || ""} onChange={(e) => update("stat_2_label", e.target.value)} placeholder="Label (multi-line)" />
          </div>
          <div className="space-y-2">
            <p className="text-sm font-medium">Stat 3</p>
            <Input value={settings.stat_3_num || ""} onChange={(e) => update("stat_3_num", e.target.value)} placeholder="Number (e.g. 10+)" />
            <Input value={settings.stat_3_label || ""} onChange={(e) => update("stat_3_label", e.target.value)} placeholder="Label (multi-line)" />
          </div>
        </div>
      </div>
